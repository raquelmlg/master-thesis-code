...
#data_frame1.to_csv("ordered_dataframes/20-4/2/model1.csv")
#data_frame2.to_csv("ordered_dataframes/20-4/2/model2.csv")
#data_frame3.to_csv("ordered_dataframes/20-4/2/model3.csv")
